...
namespace Content.Client.Options.UI.Tabs
{
    ...
    public sealed partial class MiscTab : Control
    {
        ...
        public MiscTab()
        {
            ...
            OnboardingSelector.OnItemSelected += _ =>
            {
                UpdateApplyButton();
            };
        ...
        private void OnApplyButtonPressed(BaseButton.ButtonEventArgs args)
        {
            ...
            if (OnboardingSelector.GetItemMetadata(OnboardingSelector.SelectedId) is OnboardingCategoryPrototype onboardCategory)
            {
                _cfg.SetCVar(CCVars.OnboardingHelpLevel, onboardCategory.Data.HelpLevel);
                OnboardingSelector.DefaultIndex = OnboardingSelector.SelectedId;
            }
        ...
        private void UpdateApplyButton()
        {
            ...
            var isOnboardingSame = OnboardingSelector.SelectedId == OnboardingSelector.DefaultIndex;
